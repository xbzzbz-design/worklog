...
function openDetail(id) {
  ...
  if (hasMotion(e) && e.jobType !== 'MOTION') rows.push(['Motion', `${motionSummary(e)} (+${u(motionUnitsOf(e))})`]);
  const conds = [];
  ...
  if (editBtn) editBtn.addEventListener('click', () => {
    ...
    draft = Object.assign(freshDraft(), {
      ...
      motionCustom: e.motionCustom || 0,
      motionCustomReason: e.motionCustomReason || '',
