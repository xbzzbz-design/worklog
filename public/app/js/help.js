...
const EXAMPLES = [
  ...
  { icon:'clapperboard', title:'Banner + 2 simple scenes', desc:'A banner with two still-image, text-motion scenes.', e:{ jobType:'SINGLE_BANNER', quantity:1, motionSimple:2 } },
  { icon:'film', title:'Infographic + AI motion', desc:'An infographic plus two AI-generated video scenes.', e:{ jobType:'INFOGRAPHIC', quantity:1, motionStandard:2 } },
