...
const EXAMPLES = [
  ...
  { icon:'clapperboard', title:'Banner + 2-scene motion', desc:'A banner animated into a 2-scene clip.', e:{ jobType:'SINGLE_BANNER', quantity:1, motionScenes:2 } },
  { icon:'film', title:'Infographic + 6-scene motion', desc:'A full animated explainer, 6 scenes.', e:{ jobType:'INFOGRAPHIC', quantity:1, motionScenes:6 } },
